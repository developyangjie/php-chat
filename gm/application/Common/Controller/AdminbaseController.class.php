...
class AdminbaseController extends AppframeController {
    ...
    protected function page($Total_Size = 1, $Page_Size = 0, $Current_Page = 1, $listRows = 6, $PageParam = '', $PageLink = '', $Static = FALSE) {
        ...
        $Page->SetPager('Admin', '{first}{prev}&nbsp;{liststart}{list}{listend}&nbsp;{next}{last}', array("listlong" => "9", "first" =>L('FIRST_PAGE'), "last" =>L('LAST_PAGE'), "prev" =>L('PREV_PAGE'), "next" =>L('NEXT_PAGE'), "list" => "*", "disabledclass" => ""));
        return $Page;
    }
