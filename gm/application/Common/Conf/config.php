...
$configs= array(
		...
		'MODULE_ALLOW_LIST'  => array('Portal','Admin','Portal','Asset','Api','User','Wx','Comment','Qiushi','Tpl','Topic','Install','Bug','Better','Gm','Operate','Log'),
		...
		'LANG_LIST'        => 'zh-cn,ko-kr,ja-jp', // 允许切换的语言列表 用逗号分隔
